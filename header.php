...
<head>
  ...
  <title><?php echo $title ? $title : "MikkoDC"; ?> - Portfolio Site</title>
...
<body>
  <header id="main-header" class="container">
    <a href="/portfolio" class="top-logo">
  ...
  <nav id="slide-menu" role="navigation">
      <div class="nav-inner">
        ...
        <ul class="contact-list">
          <li><i class="flaticon-letter"></i><span>Say hello</span> <a href="mailto:hello@mikkodc.com" class="fade-up-line">hello@mikkodc.com</a></li>
          <li><i class="flaticon-technology"></i><span>Let's talk</span> <a href="tel:+(971)-55-954-5484" class="fade-up-line">+(971)-55-954-5484</a></li>
        </ul>
        <div class="copyright">
          Copyright © 2017. All Rights Reserved.<br>MikkoDC.com
        </div>
      </div>
  </nav>
