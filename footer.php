<section id="contact" class="clearfix text-light">
  <div class="small-container">
    <h2 class="section-title text-center">Let's work together!</h2>
    <p class="section-sub-statement text-center">I am currently accepting new project. I'd love to hear more about your project.<br>Please take a few minutes to tell me about it.</p>
    <div class="text-center">
      <a href="mailto:mikkodecastro@ymail.com" class="btn btn-default btn-arrow-right">Let's Start!</a>
      <p>
        <a href="mailto:mikkodecastro@ymail.com">mikkodecastro@ymail.com</a>
      </p>
    </div>
  </div>
</section>
...
<script type="text/javascript" src="library/dest/js/imagesloaded.pkgd.min.js"></script>
<script src="https://unpkg.com/scrollreveal/dist/scrollreveal.min.js"></script>
<script type="text/javascript" src="library/dest/js/slick.min.js"></script>
<script type="text/javascript" src="library/dest/js/anime.min.js"></script>
<script type="text/javascript" src="library/dest/js/all.min.js"></script>
